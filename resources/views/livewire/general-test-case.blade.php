<div class="container mx-auto">
    <div class="shadow p-3 mb-5 bg-white rounded mt-8">
        <div class="header-body text-xl">
            <center>
                <h3><strong>{{ __('My Test Case') }}</strong></h3>
            </center>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="py-3 px-6">
                            <a wire:click.prevent="sortBy('test_cases.status_id')" role="button">{{ __('Status') }} <i class="fa-sharp fa-solid fa-sort"></i></a>
                        </th>
                        <th scope="col" class="py-3 px-6">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="py-4 px-6">
                        <a class="cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="commentModal" href="{{route('general.show' , $testcase->id )}}">
                            {{ __('Show') }}
                        </a>
                        </td>
                    </tr>
