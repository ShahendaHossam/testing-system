<div class="contanier mx-20">
    <div class="shadow p-3 mb-5 bg-white rounded mt-8">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="py-4 px-6 text-right">
                            <a href="{{route('test_case.show',$testcase->id)}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('View') }}</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="d-flex space-y-7 mt-4">
            {{ $testcases->links() }}
        </div>
    </div>
</div>
